    ...
    public partial class Printing_AKT_VIDACHI : Form
    {
        ...
        public Printing_AKT_VIDACHI(DataTable dtabe, Form1 mf, string valuta)
        {
            ...
            if (dTable.Rows.Count > 0)
            {
                ...
                str = str.Replace("DATAPRIEMAPRINT", DateTime.Parse(dTable.Rows[i].ItemArray[1].ToString()).ToString("dd.MM.yyyy HH:mm"));
                ...
                str = str.Replace("DATAVIDACHIPRINT", DateTime.Parse(dTable.Rows[i].ItemArray[2].ToString()).ToString("dd.MM.yyyy HH:mm"));
        ...
        private void Printing_AKT_VIDACHI_Load(object sender, EventArgs e)
        {
